...
var rule = {
    ...
    一级: async function (tid, pg, filter, extend) {
        ...
        if (extend.class === "20" || extend.class === "21") {
            ...
            // https://dm.fsdm02.com/vodshow/1--------2---2022.html
            // https://dm.fsdm02.com/vodshow/3--hits---------2023.html                        
...
async function getJwt() {
    return new Promise(async (resolve, reject) => {
        ...
        const rootResp = await retryRequest("https://dm.fsdm02.com/", { headers: { "User-Agent": UA } }, async resp => {
            await sleep(500);
