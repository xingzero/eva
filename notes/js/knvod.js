    ...
    try {
      ...
      if (res.knvod) {
        ...
        input = {
          parse: 1,
          url: parseUrl,
          parse_extra: `&init_script=${encodeURIComponent(base64Encode('document.querySelector(".art-state").click()'))}&custom_regex=tos&sniffer_exclude=20250102102756054|png|image`
        };
      }
    } catch {
      input = {
